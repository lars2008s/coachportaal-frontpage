...
import { getBlogPost, getRecentPosts } from '../../../data/blogs';
...
export default function BlogPostPage() {
    ...
    useEffect(() => {
        ...
        const recent = getRecentPosts(4).filter(p => p.slug !== params.slug).slice(0, 3);
        ...
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                    <div className="w-16 h-16 rounded-2xl bg-gray-100 flex items-center justify-center mx-auto mb-6 animate-pulse">
