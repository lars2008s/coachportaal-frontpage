...
export default function Page() {
    const features = [
        ...
        {
            title: "Slim Ledenbeheer",
            description: "Houd eenvoudig de aanwezigheid bij, beheer categorieën en krijg inzicht in de statistieken van je atleten.",
            component: <MemberManagementAnimation />,
            color: "blue"
        },
        {
            title: "Wedstrijd Resultaten",
            description: "Volg de prestaties van je atleten op de voet. Resultaten worden automatisch gekoppeld en gevisualiseerd.",
            component: <CompetitionsAnimation />,
            color: "blue"
        },
        {
            title: "Diploma Generator",
            description: "Beloon je atleten met prachtige, automatisch gegenereerde diploma's op basis van hun prestaties.",
            component: <DiplomaAnimation />,
            color: "blue"
        },
        {
            title: "Chrome Extensie",
            description: "Importeer wedstrijdresultaten direct vanaf atletiek.nu met onze handige browser extensie.",
            component: <ExtensionAnimation />,
            color: "blue"
        },
        {
            title: "Trainingsbibliotheek",
            description: "Een doorzoekbare database vol oefeningen. Filter op categorie, onderdeel of type training.",
            component: <LibraryAnimation />,
            color: "blue"
        },
        {
            title: "Herbruikbare Blokken",
            description: "Bouw trainingen razendsnel op door blokken te slepen. Maak je eigen templates voor warming-ups en kernen.",
                ...
                <div className="text-center max-w-4xl mx-auto mb-20 relative z-10">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 border border-blue-100 text-blue-700 text-[10px] font-black uppercase tracking-widest mb-8">
                            ...
                            Nieuw: Nu beschikbaar voor alle clubs
                        </div>
                        <h1 className="text-5xl sm:text-7xl font-black tracking-tighter text-gray-900 leading-[0.95] mb-8">
                            Jouw complete <br className="hidden sm:block" />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">
                                digitale assistent
                            </span>
                        </h1>
                        <p className="text-lg text-gray-500 leading-relaxed mb-10 max-w-2xl mx-auto font-medium">
                            Bespaar tijd met administratie en focus op wat echt telt: je atleten beter maken.
                            Van trainingsschema's tot wedstrijdresultaten, alles in één moderne app.
                        </p>
            ...
            <section id="features" className="scroll-mt-32">
                <div className="text-center max-w-3xl mx-auto mb-20 px-4">
                    ...
                    <p className="text-4xl sm:text-5xl font-black text-gray-900 tracking-tight leading-none">
                        Ontdek hoe Coach Portaal <br className="hidden sm:block" /> je club transformeert
                    </p>
                </div>
